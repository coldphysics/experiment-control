...
namespace Model.V1.Data.Steps
{
    ...
    public class StepRampModel : StepBasicModel
    {
        ...
        //RECO the verification of the exponential step should consider that it only produces positive values (because the value is squared). So if the upper limit is 5 and the lower limit is -10 and we set the value to -10 the output would reach +10 without validation errors.
       
        /// <summary>
        /// The implementation of the abstract method of <see cref="StepBasicModel"/>.
        /// It Verifies that the value of this step is in the range of Lowerlimit and Upperlimit, and 
        ...
        public override bool Verify()
        {
            ...
            if (Value.Value > UpperLimit())
            {
                ...
                flag = false;
                errorCollector.AddError("Value > UpperLimit at " + this.Parent.Card().Name + ", " + this.Parent.Sequence().Name + ", " + this.Parent.Setting.Name + ", Step " + this.Index(), ErrorCategory.MainHardware, false, ErrorTypes.OutOfRange);
            }
            ...
            if (Value.Value < LowerLimit())
            {
                if (Valid != null)
                    Valid(this, new EventArgs());
                flag = false;
                errorCollector.AddError("Value < LowerLimit at " + this.Parent.Card().Name + ", " + this.Parent.Sequence().Name + ", " + this.Parent.Setting.Name + ", Step " + this.Index(), ErrorCategory.MainHardware, false, ErrorTypes.OutOfRange);
            }
