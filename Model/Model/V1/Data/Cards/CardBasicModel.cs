...
using Model.V1.Data.Cookbook;
using Model.V1.Data.SequenceGroups;
using Model.V1.Data.Sequences;
using Model.V1.Data.Steps;
using System;
using System.Collections.ObjectModel;
using System.Linq;
using System.Runtime.Serialization;

namespace Model.V1.Data.Cards
{
    /// <summary>
    ...
    public abstract class CardBasicModel
    {
        ...
        //Comment: startIndex, if not found in xml file will be 0, therefore int?.
        /// <summary>
        /// The starting index when numbering the channels associated to this card. 
        /// The value is <c>Nullable</c> so it remains <c>null</c> if it is not found in the xml file, rather than being initialized to 0
        /// </summary>
        [DataMember] private int? _startIndex;

        /// <summary>
        /// Gets the integer value of <c>_startIndex</c>. If <c>_startIndex</c> is null it sets it to 1 before returning its value
        /// </summary>
        /// <value>
        /// The start index.
        /// </value>
        public int startIndex
        {
            get
            {
                if (_startIndex == null)
                {
                    _startIndex = 1;//Not usually a good idea to change the value in a getter
                }

                return (int)_startIndex;
            }
        }
        #endregion
        ...
        protected CardBasicModel(string name, uint numberOfChannels, int startIndex, CardType type, SequenceGroupModel parent)
        {
        ...
        /// <summary>
        /// Returns the time-related settings associated with the <see cref=" SequenceGroupModel" /> this card belongs to.
        /// </summary>
        /// <returns>The time-related settings associated with the <see cref=" SequenceGroupModel" /> this card belongs to</returns>
