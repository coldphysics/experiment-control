...
namespace Model.V1.Data.Cards
{
    ...
    public class CardModel : CardBasicModel
    {
        ...
        public CardModel(string name, uint numberOfChannels, int startIndex, CardType type, SequenceGroupModel sequenceGroup)
            : base(name, numberOfChannels, startIndex, type, sequenceGroup)
        {
        }
    }
}