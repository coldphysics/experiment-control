...
namespace Model.V2.Data.Channels
{
    ...
    public abstract class ChannelBasicModel
    {
        ...
        //RECO remove Channel field; it is not used nor useful
        [DataMember] public readonly int Channel;
        /// <summary>
        ...
        //RECO use the parent.ChannelSettings() rather than implementing it again
        /// <summary>
        ...
        public ChannelSettingsModel Setting
        {
            get
            {
                CardBasicModel card = Card();
                return card.Settings[Index()];
            }
        }
        #endregion
        ...
        /// <summary>
        /// Delegates the task to the parent <see cref="SequenceModel"/> .. this would end up with a reference to <see cref="Model.Data.SequenceGroups.Settings"/>
        /// </summary>
        /// <returns>A reference to the <see cref=" SequenceGroups.Settings"/></returns>
