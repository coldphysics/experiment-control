...
namespace View.Data.Steps
{
    ...
    /// </summary>
    public partial class StepDigitalRampView : System.Windows.Controls.UserControl
    {
        public StepBasicController _stepBasicController;
        ...
        private void Border_KeyDown(object sender, System.Windows.Input.KeyEventArgs e)
        {
            ...
            int isNumber = 0;
            e.Handled = !int.TryParse(KeyToChar(e.Key).ToString(), out isNumber);
