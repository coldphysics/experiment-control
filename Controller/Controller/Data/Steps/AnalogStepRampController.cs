...
namespace Controller.Data.Steps
{
    ...
    /// </summary>
    public class AnalogStepRampController : StepRampController
    {
        public AnalogStepRampController(StepRampModel model, ChannelBasicController parent) : base(model, parent)
        {
        }
    }
}
